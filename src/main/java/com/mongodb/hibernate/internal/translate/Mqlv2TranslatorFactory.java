...
public final class Mqlv2TranslatorFactory implements SqlAstTranslatorFactory {
    ...
    public SqlAstTranslator<? extends JdbcOperationQueryMutation> buildMutationTranslator(
        ...
        return delegate.buildMutationTranslator(sessionFactoryImplementor, mutationStatement);
    }
    ...
    public <O extends JdbcMutationOperation> SqlAstTranslator<O> buildModelMutationTranslator(
        ...
        return delegate.buildModelMutationTranslator(tableMutation, sessionFactoryImplementor);
    }
}
